...
function App() {
    ...
    const [name, setName] = useState("Simpson");

    const [email, setEmail] = useState("simpson@stonybrook.edu");
            ...
            <div id="id01" className={modalOpen ? 'modal' : 'closemodal'} onClick={(e) => ModalOff(e)}>
                <form className="modal-content" action="" ref={modalRef}>
                    <div className="container">
                        ...
                        <input type="text" value={name} placeholder="Enter Name" name="name" onChange={e => setName(e.target.value)} required/>

                        <label htmlFor="email"><b>Email</b></label>
                        <input type="text" value={email} placeholder="Enter Email" name="email" onChange={e => setEmail(e.target.value)}
                               required/>
